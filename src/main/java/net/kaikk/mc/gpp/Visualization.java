...
public class Visualization 
{
	...
	public static void Apply(Player player, Visualization visualization)
	{
		...
		{
			GriefPreventionPlus.instance.getServer().getScheduler().scheduleSyncDelayedTask(GriefPreventionPlus.instance, new VisualizationApplicationTask(player, playerData, visualization), 1L);
		}
	}
